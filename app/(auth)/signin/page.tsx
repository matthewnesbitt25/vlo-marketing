    ...
    <section>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Contact form */}
          <form className="mx-auto max-w-100">
            ...
            <div className="mt-6 space-y-5">
              <button className="btn w-full bg-linear-to-t from-indigo-600 to-indigo-500 bg-size-[100%_100%] bg-bottom text-white shadow-[inset_0px_1px_0px_0px_--theme(--color-white/.16)] hover:bg-size-[100%_150%]">
                Sign in
              </button>
